export type AbilityId = 'arcane_intellect' | 'frost_armor' | 'frostbolt' | 'ice_lance' | 'flurry' | 'frozen_orb' | 'blizzard' | 'glacial_spike' | 'glacial_front' | 'ice_barrier' | 'icy_veins' | 'summon_water_elemental' | 'cone_of_cold' | 'presence_of_mind' | 'rune_of_power' | 'ice_floes' | 'cold_snap' | 'greater_invisibility' | 'rings_of_frost' | 'temporal_echo' | 'temporal_mend' | 'temporal_barrier' | 'temporal_cascade' | 'temporal_rewind' | 'mass_barrier' | 'power_echo' | 'arcane_surge' | 'arcane_missiles' | 'arcane_explosion' | 'evocation' | 'perfect_moment' | 'counterspell' | 'ice_block' | 'blink' | 'frost_nova' | 'polymorph' | 'temporal_hourglass' | 'temporal_acceleration' | 'temporal_reversal' | 'collective_reversal';
export type FrostAbilityId = 'arcane_intellect' | 'frost_armor' | 'frostbolt' | 'ice_lance' | 'flurry' | 'frozen_orb' | 'blizzard' | 'glacial_spike' | 'glacial_front' | 'ice_barrier' | 'icy_veins' | 'summon_water_elemental' | 'cone_of_cold' | 'power_echo' | 'presence_of_mind' | 'rune_of_power' | 'counterspell' | 'ice_block' | 'evocation' | 'frost_nova';
