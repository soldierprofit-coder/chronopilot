export type AbilityId = 'arcane_intellect' | 'frost_armor' | 'fireball' | 'fire_blast' | 'dragons_breath' | 'scorch' | 'pyroblast' | 'flamestrike' | 'combustion' | 'meteor' | 'blazing_barrier' | 'overload' | 'frostbolt' | 'ice_lance' | 'flurry' | 'frozen_orb' | 'blizzard' | 'glacial_spike' | 'glacial_front' | 'ice_barrier' | 'icy_veins' | 'summon_water_elemental' | 'cone_of_cold' | 'presence_of_mind' | 'rune_of_power' | 'ice_floes' | 'cold_snap' | 'greater_invisibility' | 'rings_of_frost' | 'temporal_echo' | 'temporal_mend' | 'temporal_barrier' | 'temporal_cascade' | 'temporal_rewind' | 'mass_barrier' | 'power_echo' | 'arcane_surge' | 'arcane_missiles' | 'arcane_explosion' | 'evocation' | 'perfect_moment' | 'counterspell' | 'ice_block' | 'blink' | 'frost_nova' | 'polymorph' | 'temporal_hourglass' | 'temporal_acceleration' | 'temporal_reversal' | 'collective_reversal';
export type FireAbilityId = 'arcane_intellect' | 'frost_armor' | 'fireball' | 'fire_blast' | 'dragons_breath' | 'scorch' | 'pyroblast' | 'flamestrike' | 'combustion' | 'meteor' | 'blazing_barrier' | 'power_echo' | 'overload' | 'presence_of_mind' | 'rune_of_power' | 'ice_floes' | 'cold_snap' | 'greater_invisibility' | 'rings_of_frost' | 'counterspell' | 'ice_block' | 'blink' | 'polymorph' | 'evocation' | 'frost_nova';
...
export type EnemyTargetMode = 'tank-target' | 'assist-member-target' | 'current-target' | 'lowest-hp' | 'closest-engaged' | 'closest-in-range';
